...
from server.general import valid_token, decode_token, id_to_user, less_than_char, is_empty, ValueError, AccessError, authorise_token
...
def user_profile_sethandle(token, handle_str):
    ...
    if not less_than_char(handle_str, 20):
        raise ValueError(description="Handle is greater than 20 characters")
