...
from server.general import AccessError, valid_token, decode_token, valid_channel_id, user_in_channel, id_to_user, id_to_channel, ValueError, authorise_token
...
def channel_join(token, channel_id):
    ...
    # silently fail if user is already part of the channel
        ...
        if channel['is_public'] or user_object['permission_id'] < 3:
            ...
            raise AccessError(description="Channel is a private channel")
