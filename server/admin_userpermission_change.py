...
from server.general import decode_token, id_to_user, user_exists, AccessError, ValueError, authorise_token
...
def admin_userpermission_change(token, u_id, permission_id): 
    ...
    # u_id provided cannot be found in the database 
        ...
        raise ValueError(description="User is not registered")
