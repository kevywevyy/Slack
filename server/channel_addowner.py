...
from server.general import AccessError, decode_token, valid_channel_id, id_to_channel, id_to_user, user_is_owner, ValueError, authorise_token
...
def channel_addowner(token, channel_id, u_id):
    if not valid_channel_id(channel_id):
        ...
        # user is trying to add a user who is already an owner
            ...
            raise ValueError(description="User is already an owner")
