from server.general import less_than_char, is_empty, decode_token, id_to_user, AccessError, ValueError, user_exists, user_in_channel, authorise_token
...
def user_profile_setname(token, name_first, name_last):
    ...
    if is_empty(name_first) or is_empty(name_last):
        raise ValueError(description="User must have both a first and last name")
